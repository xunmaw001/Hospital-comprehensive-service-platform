...
public class HuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuanzheEntity user = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody HuanzheEntity huanzhe){
    	...
    	HuanzheEntity user = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("zhanghao", huanzhe.getZhanghao()));
		if(user!=null) {
