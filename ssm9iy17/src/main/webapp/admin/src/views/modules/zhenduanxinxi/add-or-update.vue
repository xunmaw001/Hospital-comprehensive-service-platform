<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zhenduantupian" label="诊断图片" prop="zhenduantupian">
          <file-upload
          tip="点击上传诊断图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhenduantupian?ruleForm.zhenduantupian:''"
          @change="zhenduantupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhenduantupian" label="诊断图片" prop="zhenduantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhenduantupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病情登记" prop="bingqingdengji">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.bingqingdengji" label="病情登记" prop="bingqingdengji">
                    <span>{{ruleForm.bingqingdengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.zhenduantupian!=null) {
		this.ruleForm.zhenduantupian = this.ruleForm.zhenduantupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zhenduantupianUploadChange(fileUrls) {
	this.ruleForm.zhenduantupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
